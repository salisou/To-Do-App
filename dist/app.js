...
function addTask() {
    const taskInput = document.getElementById("taskInput"); // Recupera l'input dell'utente
    ...
    const taskList = document.getElementById("taskList"); // Recupera la lista delle attività
